...
#include "const.hpp"
#include "idealMHD_2D_periodicX_symmetricY.hpp"
...
void IdealMHD2DPeriodicXSymmetricY::oneStepRK2()
{
...
void IdealMHD2DPeriodicXSymmetricY::save(
...
void IdealMHD2DPeriodicXSymmetricY::calculateDt()
{
    thrust::transform(
        U.begin(), 
        U.end(), 
...
bool IdealMHD2DPeriodicXSymmetricY::checkCalculationIsCrashed()
{
...
void IdealMHD2DPeriodicXSymmetricY::shiftUToCenterForCT(
...
void IdealMHD2DPeriodicXSymmetricY::backUToCenterHalfForCT(
    thrust::device_vector<ConservationParameter>& U
)
{
    dim3 threadsPerBlock(16, 16);
...
// getter
thrust::device_vector<ConservationParameter> IdealMHD2DPeriodicXSymmetricY::getU()
{
    return U;
}
