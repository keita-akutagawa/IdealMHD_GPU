...
std::string directoryname = "/cfca-work/akutagawakt/IdealMHD_multiGPU/results_shock_tube_test5b";
std::string filenameWithoutStep = "shock_tube";
std::ofstream logfile("/cfca-work/akutagawakt/IdealMHD_multiGPU/results_shock_tube_test5b/log_shock_tube.txt");
