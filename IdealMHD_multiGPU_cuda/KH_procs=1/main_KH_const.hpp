...
std::string directoryname = "/cfca-work/akutagawakt/IdealMHD_multiGPU_cuda/results_KH_procs=1_2";
std::string filenameWithoutStep = "KH";
std::ofstream logfile("/cfca-work/akutagawakt/IdealMHD_multiGPU_cuda/results_KH_procs=1_2/log_KH.txt");
