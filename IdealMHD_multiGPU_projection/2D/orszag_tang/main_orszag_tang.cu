...
int main(int argc, char** argv)
{
    ...
    if (mPIInfo.rank == 0) {
        ...
        std::cout << mPIInfo.localGridX << "," << mPIInfo.localGridY << std::endl;
        std::cout << mPIInfo.localNx << "," << mPIInfo.localNy << std::endl;
        std::cout << mPIInfo.localSizeX << "," << mPIInfo.localSizeY << std::endl;
