...
void Boundary::periodicBoundary2nd(
...
void symmetricBoundary2nd_kernel(ConservationParameter* U)
{
    ...
    U[device_nx-1].rho  = U[device_nx-3].rho;
    U[device_nx-1].rhoU = U[device_nx-3].rhoU;
    U[device_nx-1].rhoV = U[device_nx-3].rhoV;
    U[device_nx-1].rhoW = U[device_nx-3].rhoW;
    U[device_nx-1].bX   = U[device_nx-3].bX;
    U[device_nx-1].bY   = U[device_nx-3].bY;
    U[device_nx-1].bZ   = U[device_nx-3].bZ;
    U[device_nx-1].e    = U[device_nx-3].e;
    U[device_nx-2].rho  = U[device_nx-3].rho;
    U[device_nx-2].rhoU = U[device_nx-3].rhoU;
    U[device_nx-2].rhoV = U[device_nx-3].rhoV;
    U[device_nx-2].rhoW = U[device_nx-3].rhoW;
    U[device_nx-2].bX   = U[device_nx-3].bX;
    U[device_nx-2].bY   = U[device_nx-3].bY;
    U[device_nx-2].bZ   = U[device_nx-3].bZ;
    U[device_nx-2].e    = U[device_nx-3].e;
}
