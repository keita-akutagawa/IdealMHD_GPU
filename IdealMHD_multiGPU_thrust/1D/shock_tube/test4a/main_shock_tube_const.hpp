...
std::string directoryname = "/cfca-work/akutagawakt/IdealMHD_multiGPU/results_shock_tube_test4a";
std::string filenameWithoutStep = "shock_tube";
std::ofstream logfile("/cfca-work/akutagawakt/IdealMHD_multiGPU/results_shock_tube_test4a/log_shock_tube.txt");
